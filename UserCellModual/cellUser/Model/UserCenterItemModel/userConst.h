...
#define LeftGap 12
#define IndicatorArrow @"arrow"

#define funcNameWidthLimit 180
#define funcImgWidth 30
#define LeftMiddleGap 10
#define TopGap 8
#define RightMiddleGap 6       //in right part: the gap between image and label
